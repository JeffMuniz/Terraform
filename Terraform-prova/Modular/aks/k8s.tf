...
resource "azurerm_kubernetes_cluster" "aks" {
  ...
  depends_on = [
    azurerm_user_assigned_identity.id_aks, azurerm_subnet_route_table_association.rt_subnet, azurerm_role_assignment.aks_permissions02_vnet, azurerm_role_assignment.aks_permissions02,
  ]
...
resource "azurerm_role_assignment" "aks_permissions02" {
...
resource "azurerm_role_assignment" "aks_permissions02_vnet" {
